...
set "AMENT_ENVIRONMENT_HOOKS[interfaces]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interfaces] "%AMENT_CURRENT_PREFIX%\share\interfaces\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interfaces] "%AMENT_CURRENT_PREFIX%\share\interfaces\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[interfaces] "%AMENT_CURRENT_PREFIX%\share\interfaces\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[interfaces]:;=";"%") do (
    call:call_file %%f
  )
