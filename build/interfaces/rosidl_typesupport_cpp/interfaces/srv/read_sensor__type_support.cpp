...
static const _ReadSensor_Request_type_support_symbol_names_t _ReadSensor_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ReadSensor_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ReadSensor_Request)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ReadSensor_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, ReadSensor_Request)() {
  return get_message_type_support_handle<interfaces::srv::ReadSensor_Request>();
}
...
static const _ReadSensor_Response_type_support_symbol_names_t _ReadSensor_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ReadSensor_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ReadSensor_Response)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ReadSensor_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces, srv, ReadSensor_Response)() {
  return get_message_type_support_handle<interfaces::srv::ReadSensor_Response>();
}
...
static const _ReadSensor_type_support_symbol_names_t _ReadSensor_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, srv, ReadSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces, srv, ReadSensor)),
  }
};
...
{
  return &::interfaces::srv::rosidl_typesupport_cpp::ReadSensor_service_type_support_handle;
}
