...
#include "interfaces/msg/detail/sensor_read__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::SensorRead & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::SensorRead & ros_message)
{
  // Member: reading
  {
    cdr >> ros_message.reading;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::SensorRead *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::SensorRead *>(
    untyped_ros_message);
...
static size_t _SensorRead__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_SensorRead(full_bounded, 0);
}
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_SensorRead__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, SensorRead)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_SensorRead__handle;
}
